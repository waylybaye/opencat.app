...
import frame from '@/images/meta/phone-frame.svg'
...
export function PhoneFrame({
  ...
  priority = false,
  ...props
}: React.ComponentPropsWithoutRef<'div'> & { priority?: boolean, padding?: boolean }) {
  return (
    <div className={clsx('relative aspect-[366/729]', className)} {...props}>
      ...
      <div className={clsx('absolute left-[calc(23/366*100%)] top-[calc(23/729*100%)] grid h-[calc(686/729*100%)] w-[calc(318/366*100%)] transform grid-cols-1 overflow-hidden bg-[#F6F5F8]', padding ? 'pt-[calc(23/318*100%)]' : '')}>
        {children}
      </div>
