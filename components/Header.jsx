...
export const Header = () => {
  return (
    <div className="flex justify-between px-8 py-6 w-full md:max-w-3xl mx-auto sticky top-0 items-center bg-gray-100/25 dark:bg-gray-800/75 backdrop-blur-xl " >
